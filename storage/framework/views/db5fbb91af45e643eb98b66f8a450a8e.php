...
<head>
    ...
    <title><?php echo e($title ?? 'Zendesk Auth'); ?></title>
...
<body x-data class="min-h-screen bg-muted/30 text-foreground font-sans selection:bg-primary selection:text-primary-foreground flex flex-col items-center justify-center p-4">
    <div class="absolute top-4 right-4 flex items-center gap-2">
        <a href="<?php echo e(route('home')); ?>" class="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
            Back to website
        </a>
    </div>
...
<?php /**PATH C:\laragon\www\zendesk\resources\views/layouts/auth.blade.php ENDPATH**/ ?>