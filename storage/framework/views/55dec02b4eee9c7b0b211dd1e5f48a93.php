...
<div
    ...
    <?php if($id): ?>
        @open-alert-dialog-<?php echo e($id); ?>.window="open = true"
        @close-alert-dialog-<?php echo e($id); ?>.window="open = false"
    <?php endif; ?>
...
<?php /**PATH C:\laragon\www\zendesk\resources\views/components/ui/alert-dialog.blade.php ENDPATH**/ ?>