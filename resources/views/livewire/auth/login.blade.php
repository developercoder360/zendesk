    ...
    <x-ui.tabs wire:model="tab" class="w-full">
        ...
        <x-ui.tabs-content value="signup" class="mt-6">
            <div class="mb-6">
                ...
                <p class="text-muted-foreground mt-1 text-sm">Start your 14-day free trial. No credit card required
                    during trial.</p>
            </div>
            ...
            @elseif ($step === 'payment')
                <div class="space-y-6">
                    ...
                    <div class="bg-muted p-4 rounded-lg flex justify-between items-center">
                        <span class="font-medium">{{ App\Models\Package::find($packageId)->name ?? '' }}
                            Package</span>
                        <span
                            class="font-bold">${{ number_format((App\Models\Package::find($packageId)->price ?? 0) / 100, 2) }}
                            <span class="text-sm font-normal text-muted-foreground">/mo</span></span>
                    </div>
                    <div class="space-y-2">
