...
<div class="flex h-full flex-col">
    <div class="flex h-16 shrink-0 items-center px-6">
        <a href="{{ route('central.dashboard') }}" class="flex items-center gap-2 font-semibold">
    ...
    <div class="flex-1 overflow-auto py-4">
        <nav class="grid gap-1 px-4">
            ...
            <a href="{{ route('central.dashboard') }}" @class(['flex items-center gap-3 rounded-lg px-3 py-2 text-sm transition-all', 'bg-accent text-accent-foreground' => request()->routeIs('central.dashboard'), 'text-muted-foreground hover:bg-accent hover:text-accent-foreground' => !request()->routeIs('central.dashboard')])>
            ...
            <a href="{{ route('central.billing') ?? '#' }}" @class(['flex items-center gap-3 rounded-lg px-3 py-2 text-sm transition-all', 'bg-accent text-accent-foreground' => request()->routeIs('central.billing'), 'text-muted-foreground hover:bg-accent hover:text-accent-foreground' => !request()->routeIs('central.billing')])>
                <x-lucide-credit-card class="size-4" />
                Billing
            </a>

            <a href="{{ route('central.account') ?? '#' }}" @class(['flex items-center gap-3 rounded-lg px-3 py-2 text-sm transition-all', 'bg-accent text-accent-foreground' => request()->routeIs('central.account'), 'text-muted-foreground hover:bg-accent hover:text-accent-foreground' => !request()->routeIs('central.account')])>
