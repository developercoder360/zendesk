                        ...
                        @forelse ($departments as $department)
                            <x-ui.table-row>
                                ...
                                <x-ui.table-cell class="text-right">
                                    ...
                                    <x-ui.button variant="ghost" size="sm" wire:click="delete('{{ $department->id }}')" class="text-red-500 hover:text-red-600">
                                        Delete
                                    </x-ui.button>
                                </x-ui.table-cell>
                            </x-ui.table-row>
            ...
            <form wire:submit="save">
                <div class="grid gap-4 py-4">
                    ...
                    <div class="flex items-center space-x-2">
                        <input type="checkbox" id="isActive" wire:model="isActive" class="rounded border-input text-primary focus:ring-primary h-4 w-4">
